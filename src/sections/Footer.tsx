...
const resourceLinks = [
  ...
  { label: 'Strat Planner Pro', href: 'https://asilvainnovations.com/strat-plan-pro/' },
  { label: 'Real-Time Leadership', href: 'https://asilvainnovations.com/trl/' },
];
...
const companyLinks = [
  ...
  { label: 'Partnerships', href: 'https://asilvainnovations.com/partnerships/' },
];
...
const legalLinks = [
  ...
  { label: 'AI Ethics and Policy Framework', href: 'https://asilvainnovations.com/ai-ethics-and-policy-framework/' },
];
